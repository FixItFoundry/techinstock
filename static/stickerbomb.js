...
(function () {
  ...
  const PRIMARY_STICKERS = [
    ...
    { id: 'xps', name: 'Dell XPS', file: 'xps.svg', w: 92, h: 27 },
    ...
    { id: 'fractaldesign', name: 'Fractal Design', file: 'fractaldesign.png', w: 98, h: 30 },
    { id: 'thermalright', name: 'Thermalright', file: 'thermalright.png', w: 105, h: 24 },
  ...
  const SECONDARY_STICKERS = [
    ...
    { id: 'anker', name: 'Anker', file: 'anker.png', w: 92, h: 24 },
